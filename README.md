...
*   **Cowrie Honeypot:** An SSH and Telnet honeypot that captures attacker interactions.
*   **Filebeat:** A lightweight log shipper that forwards Cowrie logs to Elasticsearch.
*   **Elasticsearch:** A distributed search and analytics engine that stores and indexes the raw and processed event data.
*   **Kibana:** A data visualization and exploration tool that provides a dashboard for monitoring and analyzing the threat intelligence.
